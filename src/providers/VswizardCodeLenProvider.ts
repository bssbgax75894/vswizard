 ...
 */
export class VswizardCodeLensProvider implements CodeLensProvider {
    ...
    public async provideCodeLenses(
        ...
        if (
            workspace.getConfiguration("vswizard").get("codeLens.enabled") ===
                false ||
    ...
    private resolvePreviousCodeLens(
        ...
        lens.command = {
            ...
            command: "vswizard.previousAlternative",
            arguments: [],
        };
        return lens;
    }
    ...
    private resolveNextCodeLens(
        ...
        lens.command = {
            ...
            command: "vswizard.nextAlternative",
            arguments: [],
        };
        return lens;
    }
    ...
    private resolveAcceptCodeLens(
        ...
        lens.command = {
            ...
            command: "vswizard.acceptAlternative",
            arguments: [],
        };
        return lens;
    }
